const CACHE='vtm-v6-alpha-chargen-v0.7.0';
const ASSETS=['./','./index.html','./manifest.webmanifest','./data/v6.js','./data/v6_uk.js','./src/i18n.js','./src/app.js','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
