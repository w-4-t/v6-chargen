window.V6_LOCALES = window.V6_LOCALES || {}; window.V6_LOCALES.en = {
  ...
  "strings": {
    "messages": {
          ...
          "creatureMeta": "Max dots {maxDots} · Chargen max Discipline {maxDiscipline} · Generation Modifier {modifier}",
          "creatureLifepaths": "{count} Lifepaths",
          "creatureAttributes": "Attributes {budgets}",
          "creatureDisciplineDots": "{dots}+{bonus} Discipline dots",
