window.V6_LOCALES = window.V6_LOCALES || {}; window.V6_LOCALES.en = {
  ...
  "strings": {
    "messages": {
      "customLifepathFallback": "Custom Lifepath ({id})",
      "mortalLifepaths": "Mortal Lifepaths",
      "neonateVampireLifepaths": "Neonate Vampire Lifepaths",
      "ancillaVampireLifepaths": "Ancilla Vampire Lifepaths",
      "elderVampireLifepaths": "Elder Vampire Lifepaths",
      ...
      "lifepathResourceMatrixLead": "Shared Resources occupy a single row while each Lifepath keeps its own allocation column.",
      "skill": "Skill",
      "resource": "Resource",
      "total": "Total",
      "resetLifepathAllocations": "Reset allocations",
      "confirmResetLifepathAllocations": "Reset all Lifepath Skill and Resource allocations? The selected Lifepaths will remain selected.",
      "confirmResetCustomLifepath": "Reset the user-created Lifepath {name}? Its name, description, Skills, Resources, and any allocations from it will be cleared.",
      "moveLifepathEarlier": "Move {name} earlier",
      "moveLifepathLater": "Move {name} later",
      "confirmRemoveLifepathAllocations": "Removing {name} will discard its Skill and Resource allocations. Continue?",
      "confirmDeleteCustomLifepath": "Delete the user-created Lifepath {name} and its embedded Resource definitions?",
      "confirmEditCustomLifepathAllocations": "Editing the structure of {name} will reset the affected Lifepath allocations. Continue?",
      "validationCustomResourceDuplicates": "Custom Lifepath {n} must define three distinct Resources.",
      ...
      "skillFromLifepathsCompactLabel": "From Lifepaths",
    ...
    "text": {
      ...
      "s_93b9dac31ca1": "Choose the Primary, Secondary, and Tertiary Attribute categories, then distribute the available dots in each category.",
