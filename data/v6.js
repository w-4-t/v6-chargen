window.V6_DATA = {
  attributes: [
    {
      ...
      category: "Physical",
      description:
        "Physical prowess, brute force, and how much weight you can lift. Influences how much damage you can inflict in Melee combat, the strength of your grip, and how much Vitae you can drain from a victim in a single turn.",
      ratings: {
    ...
    },
    {
      ...
      category: "Physical",
      description:
        "Agility, reflexes, and hand-eye coordination. Influences how precise you are in combat, how hard it is to hit you, and how much fine skill you can display when working against the clock.",
      ratings: {
    ...
    },
    {
      ...
      category: "Physical",
      description:
        "Endurance, vigor, and constitution in the face of physical and biological threats. Influences how much Vitae your body can hold, how long you can keep running, and how well you resist threats to your body’s functions. This Attribute is often used when defending yourself against physical Discipline powers.",
      ratings: {
    ...
    },
    {
      ...
      category: "Social",
      description:
        "Personal magnetism, natural charm, and strength of personality. Often used when you are trying to attract attention, make a good first impression, or leave a strong impact on someone.",
      ratings: {
    ...
    },
    {
      ...
      category: "Social",
      description:
        "The ability to sway the truth, craft convincing lies, and bend others to your needs. Often used when you need to twist facts and convince others of things that aren’t true.",
      ratings: {
    ...
    },
    {
      ...
      category: "Mental",
      description:
        "Reason, memory, and the ability to apply logic to solve problems. It is often used when analyzing large volumes of information, remembering obscure facts, and solving logical puzzles.",
      ratings: {
    ...
    },
    {
      ...
      category: "Mental",
      description:
        "Intuition, perception and the ability to react quickly to changing circumstances. It is often used to perceive hidden information and to react quickly in rapidly evolving situations.",
      ratings: {
    ...
    },
    {
      ...
      category: "Mental",
      description:
        "Determination, mental fortitude, and the capacity to keep going even when your energy is faltering. Often used to maintain focus in mentally stressful circumstances and to push through mental blocks. This Attribute is often used when defending against mental Discipline powers.",
      ratings: {
  ...
  skills: [
    {
      ...
      name: "Athletics",
      description:
        "Your physical training and aptitude for athletic activities, such as running after someone or climbing the side of a building.",
      focuses: [
        {
          name: "Climbing",
          description:
            "Training in climbing rough surfaces with or without appropriate equipment.",
        },
        {
          name: "Lifting",
          description:
            "Training to lift heavier weights in safe ways, using your strength more efficiently.",
        },
        {
          name: "Running",
          description:
            "Training to run greater distances and reach higher speeds.",
        },
        {
          name: "Throwing",
          description:
            "Training with throwing, typically aerodynamic, objects with a focus on accuracy and distance.",
        },
      ],
    },
    {
      ...
      name: "Awareness",
      description:
        "Your ability to perceive subtle changes in behavior, strange patterns in the environment, and even signs of the supernatural.",
      focuses: [
        {
          name: "Empathy",
        ...
        },
        {
          name: "Insight",
          description:
            "Reading nuances of body language, inflection, tone, and similar to better understand an individual’s true meaning, discerning truth from lies and understanding implications versus spoken words.",
        },
        {
          name: "Instinct",
          description:
            "Natural intuition about the environment and nearby people and recognizing the threats within them.",
        },
        {
          name: "Supernatural",
          description:
            "Innate perception and sensitivity to things that aren’t quite natural, such as supernatural creatures, objects, and powers.",
        },
      ],
    },
    {
      ...
      name: "Craft",
      description:
        "Your technical abilities regarding building, fixing, and improvising improvements to technical equipment, from carpentry to computers.",
      focuses: [
        {
          name: "Carpentry",
          description:
            "Working with wood, including making wooden objects, repairing structures, and even tearing them down.",
        },
        {
          name: "Computers",
          description:
            "Working with computer hardware, including quickly putting together an electronic device, fixing burned boards, or even modifying the hardware components of a computer.",
        },
        {
          name: "Engines",
          description:
            "Working with engines, including putting them together, taking them apart, repairing them, and even forcing them to turn on or off. This focus is typically divided into small engines and large engines.",
        },
        {
          name: "Forgery",
          description:
            "Creating and detecting fake pieces of art, false documents, and other counterfeit objects.",
        },
        {
          name: "Improvised",
          description:
            "Creating an improvised, and typically temporary, mechanism or tool to solve an immediate problem with only the parts and other objects at hand.",
        },
      ],
    },
    {
      ...
      name: "Expression",
      description:
        "Your ability to express yourself in different artistic ways, from writing to playing music to acting.",
      focuses: [
        {
          name: "Acting",
          description:
            "Portraying people, caricatures, and personas, typically through physical storytelling.",
        },
        {
          name: "Drawing",
        ...
        },
        {
          name: "Music",
          description:
            "Creating or performing music through composing, playing an instrument, singing or similar.",
        },
        {
          name: "Sculpting",
          description:
            "Shaping material, typically clay, marble, or some other earthen medium, into three-dimensional objects for artistic expression rather than practical application.",
        },
        {
          name: "Writing",
          description:
            "Creating cogent text, inspiring prose, or humorous poetry.",
        },
      ],
    },
    {
      ...
      name: "Fighting",
      description:
        "Your training in physical combat, such as brawling, knife fights, and even medieval melee weaponry.",
      focuses: [
        {
          name: "Fighting Dirty",
          description:
            "Using every advantage in the environment to win a fight, such as throwing dirt in an opponent’s eyes to blind them, typically in a way that might be considered dishonorable in a more formal duel.",
        },
        {
          name: "Hand-to-Hand",
          description:
            "Using weaponless combat, which often uses punches, kicks, knees, or the whole body to fight.",
        },
        {
          name: "Improvised Weaponry",
          description:
            "Using whatever objects are at hand to fight an opponent, such as using a broken plate to slash at someone in a restaurant.",
        },
        {
          name: "Medieval Weaponry",
          description:
            "Using swords, axes, spears, and other ancient, melee weaponry.",
        },
      ],
    },
    {
      ...
      name: "Investigation",
      description:
        "Your ability to apply attention and deductive reasoning to acquire scattered or hidden information, whether searching a crime scene or digging through old tomes in a library.",
      focuses: [
        {
          name: "Crime Scene",
          description:
            "Assessing crime scenes and other areas with evidence of conflict or illicit activity for clues and other details about the happenings there.",
        },
        {
          name: "Digital Media",
          description:
            "Discovering information through digital media, from diving through digital archives, to scouring the right places on the internet, to finding hidden data on hard drives. Also represents the ability to quickly analyze large amounts of data for the necessary information.",
        },
        {
          name: "Gossip",
          description:
            "Talking to the right people and asking the right questions to learn the latest information and rumors about others and their activities, typically those inside society, especially higher society.",
        },
        {
          name: "Physical Media",
          description:
            "Discovering information through physical media, from poring through ancient tomes, to reading dozens of case files, to understanding and utilizing an old filing system. Also represents the ability to quickly analyze large amounts of data for the necessary information.",
        },
        {
          name: "Streetwise",
          description:
            "Talking to the right people and asking the right questions to learn the latest information and rumors about others and their activities, typically those that lurk in the shadows and beneath or outside standard society.",
        },
      ],
    },
    {
      ...
      name: "Knowledge",
      description:
        "Your grasp of facts and ability to recall information on various topics.",
      focuses: [
        {
          name: "Chemistry",
          description:
            "The study of chemical processes of the world, including how certain chemicals interact with each other, the human body, and the environment.",
        },
        {
          name: "History",
          description:
            "The study of history of the world, including when major events happened, who was involved, and what resulted from them.",
        },
        {
          name: "Law",
          description:
            "The study of laws of a country and how to use and manipulate them.",
        },
        {
          name: "Linguistics",
          description:
            "The study of how languages work, including being able to decipher ancient languages or create new ones.",
        },
        {
          name: "Occult",
          description:
            "The study of the supernatural and other mystic occurrences, often through strange and ancient tomes and myths.",
        },
        {
          name: "Politics",
          description:
            "The study of government structures and functions, especially in how they relate to the power play between the various parties and entities within them.",
        },
      ],
    },
    {
      ...
      name: "Medicine",
      description:
        "Your training in medical practices, from first aid to surgery to psychology.",
      focuses: [
        {
          name: "Animals",
          description:
            "Treatment of animals for various ailments, including knowledge of animal-specific medications and the ability to perform surgeries. This focus is typically divided into exotic animals, large animals, and small animals.",
        },
        {
          name: "First Aid",
          description:
            "Performing emergency medical assistance, such as resuscitation or halting bleeding, until the injured party can receive full medical attention.",
        },
        {
          name: "Psychology",
          description:
            "The treatment of mental and intellectual conditions, including knowledge of various therapeutic activities and the appropriate medications for psychiatric treatments.",
        },
        {
          name: "Surgery",
          description:
            "Performing medical treatments with instruments, particularly treatments that involve the removal or replacement of diseased tissue.",
        },
        {
          name: "Toxicology",
    ...
    },
    {
      ...
      name: "Persuasion",
      description:
        "Your training in the social game of influencing others to do what you want, whether through subtle or imposing ways.",
      focuses: [
        {
          name: "Fraternize",
          description:
            "Forging positive connections with people and easily making friends, especially with individuals typically considered opposing or unfriendly.",
        },
        {
          name: "Intimidation",
          description:
            "Using your appearance, strength, or position to bully others or get what you want.",
        },
        {
          name: "Negotiation",
          description:
            "The art of give and take, compromise, and finding middle grounds between opposing parties.",
        },
        {
          name: "Seduction",
          description:
            "Using your charm and appearance to entice others in a romantic or sensual way.",
        },
      ],
    },
    {
      ...
      name: "Sabotage",
      description:
        "Your ability to overcome and undo security measures, as well as your ability to use destructive methods, such as explosives, to take down and damage things.",
      focuses: [
        {
          name: "Burglary",
          description:
            "Breaking and entering, opening coffers, and kicking in or unlocking doors, typically in a destructive way or without regard for keeping the barrier to entry, such as a door, intact.",
        },
        {
          name: "Explosives",
        ...
        },
        {
          name: "Hacking",
          description:
            "Gaining access to restricted information, data, and networks, typically through rewriting or disrupting software code.",
        },
        {
          name: "Security Systems",
          description:
            "Circumventing complex security systems, from disabling or fooling a network of security cameras to bypassing biometric scanners to breaking into encrypted files and networks.",
        },
      ],
    },
    {
      ...
      name: "Shooting",
      description:
        "Your training in ranged combat, such as firing a gun, loosing an arrow, or even operating artillery.",
      focuses: [
        {
          name: "Heavy Firearms",
          description:
            "Using high caliber guns and similar ranged weapons, such as rifles, machine guns, and powerful handguns.",
        },
        {
          name: "Improvised Weaponry",
          description:
            "Using makeshift ranged weapons, homemade guns, and whatever objects are at hand to fight an opponent at a distance.",
        },
        {
          name: "Light Firearms",
          description:
            "Using low caliber guns and similar ranged weapons, such as pistols, revolvers, and submachine guns.",
        },
        {
          name: "Medieval Weaponry",
          description:
            "Using bows, crossbows, and other ancient, ranged weaponry.",
        },
      ],
    },
    {
      ...
      name: "Subterfuge",
      description:
        "Your ability to be an accomplished thief or con artist, from moving around unseen to lying your way out of complicated situations.",
      focuses: [
        {
          name: "Deceit",
          description:
            "Lying and deceiving others into believing what you say is true.",
        },
        {
          name: "Disguise",
          description:
            "Appearing to be who you are not. This focus encompasses the ability to mimic speech and behavior patterns as well as the ability to create physical costumes and similar objects related to disguising.",
        },
        {
          name: "Skulking",
          description:
            "Following others without drawing attention from them, often appearing as part of the surrounding crowd or environment.",
        },
        {
          name: "Sleight of Hand",
          description:
            "Manipulating objects without the manipulation being seen or detected, such as stealing something from someone’s pocket or performing a “magic” trick in front of an audience.",
        },
        {
          name: "Stealth",
          description:
            "Remaining undetected by anyone around you, typically through hiding or keeping silent.",
        },
      ],
    },
    {
      ...
      name: "Survival",
      description:
        "Your practical resourcefulness and aptitude for surviving despite your situation, especially when it comes to finding shelter, dealing with animals, or following tracks.",
      focuses: [
        {
          name: "Animal Handling",
          description:
            "Dealing with animals in a peaceful way, typically through calming them. This focus also encompasses making yourself understood by an animal and understanding the behavior of an animal.",
        },
        {
          name: "Foraging",
          description:
            "Finding resources and shelter in inhospitable environments or when resources and shelter are otherwise unavailable. This focus is typically divided into urban foraging and wilderness foraging.",
        },
        {
          name: "Hunting",
          description:
            "Finding and hunting non-human prey. This focus is typically divided into urban hunting and wilderness hunting.",
        },
        {
          name: "Shelter",
          description:
            "Creating shelter and finding basic resources, such as water, firewood, and other material for camping, keeping warm, or otherwise making it through a sleep cycle in an inhospitable location.",
        },
        {
          name: "Tracking",
          description:
            "Finding and following the tracks left by a creature. This focus is typically divided into urban tracking and wilderness tracking.",
        },
      ],
    },
  ],
  sires: [
    ...
    },
    {
      ...
      description:
        "Your sire took care of and tutored you in the ways of vampires.",
    },
    {
      id: "cruel_sire",
      name: "Cruel Sire",
    ...
    },
    {
      ...
      description:
        "Your sire was a master of manipulation, and you were often a pawn in their schemes.",
    },
    {
      id: "secretive_sire",
      name: "Secretive Sire",
  ...
  lifepaths: [
    {
      ...
      tier: "mortal",
      description:
        "You are a writer, actor, painter, designer, sculptor, or a creative of any other kind. You might have focused on one art form or have explored many different forms of expression, as you figured out how to express yourself.",
      skills: [
        {
          skill: "awareness",
          focus: "",
    ...
    },
    {
      ...
      tier: "mortal",
      description:
        "Your battlefield is the corporate boardroom, where you exercise your quick wits and sharp acumen. You do what you need to get what you want, and you know how to use people that are standing in your way.",
      skills: [
        {
          skill: "awareness",
          focus: "",
    ...
    },
    {
      ...
      tier: "mortal",
      description:
        "You make your living by breaking the law, either by taking what you want from others who have it, or by more subtle means. You might have spent some time in prison or worked with other criminals in an organized fashion, and now you count some of them among your contacts.",
      skills: [
        {
          skill: "athletics",
          focus: "Running",
    ...
    },
    {
      ...
      tier: "mortal",
      description:
        "You dedicated part of your life to the study and dissemination of a religious faith. You might have delved deep into mythological studies and discovered a lot about the hidden world before you became what you are today.",
      skills: [
        {
          skill: "awareness",
          focus: "",
    ...
    },
    {
      ...
      tier: "mortal",
      description:
        "You know how to track prey, set traps, and survive in the areas where your quarry is located. You might have grown up near the wilderness, or you might have just hunted for sport. Either way, you understand your quarry’s behavior and use it to your advantage.",
      skills: [
        {
          skill: "awareness",
          focus: "",
    ...
    },
    {
      ...
      tier: "mortal",
      description:
        "You served your country in its armed forces and received extensive training in the art of war and survival. Weapons are your most trusted tools, and you rarely leave your companions behind. You might still have contact with some of your former comrades, as you survived hell together.",
      skills: [
        {
          skill: "athletics",
          focus: "",
    ...
    },
    {
      ...
      tier: "mortal",
      description:
        "You worked in the political arena, making policies, negotiating deals, and battling for the public’s attention. You learned that the political game runs on negotiation, and that most of it happens well outside the legal boundaries.",
      skills: [
        {
          skill: "awareness",
          focus: "Insight",
    ...
    },
    {
      ...
      tier: "mortal",
      description:
        "You learned how to work with your hands, even without the deep theoretical knowledge to back it up. You are resourceful and can usually figure your way out of most problems you face.",
      skills: [
        {
          skill: "athletics",
          focus: "",
    ...
    },
    {
      ...
      tier: "neonate",
      description:
        "Vampires need blood, and some have specific tastes and requirements. That’s where you come in. You hunt down the blood they need and deliver it to them. You might have discovered a way to get rich after becoming a vampire, or you were simply coerced into service by the elders, possibly with the promise of greater status.",
      skills: [
        {
          skill: "athletics",
          focus: "",
    ...
    },
    {
      ...
      tier: "neonate",
      description:
        "When things get messy, you are called to make the trouble disappear. It’s a dirty job, but someone has to do it. That someone is you. You might have been forced into this role, or you might have taken it to earn favors and boons from those that need your services.",
      skills: [
        {
          skill: "athletics",
          focus: "",
    ...
    },
    {
      ...
      tier: "neonate",
      description:
        "You can also use this [lifepath] to represent a Sweeper or Ductus. You were the muscle for the local authority, using your martial training and limited authority to keep the domain safe and make others follow the rules. Whether you wielded that power wisely or abused it is up to you, but other vampires will resent you either way.",
      skills: [
        {
          skill: "fighting",
          focus: "",
    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          skill: "persuasion",
          focus: "",
          focusOptions: ["Fraternizing", "Negotiation"],
        },
        {
          skill: "subterfuge",
          focus: "",
    ...
    },
    {
      ...
      tier: "ancilla",
      description:
        "You set the tone of vampiric society, shaping how others behaved and even how they thought. You kept the ledger of who owed favors to whom, you could raise a reputation or ruin one, and you often held secrets and information that everyone else worked to keep hidden.",
      skills: [
        {
          skill: "awareness",
          focus: "",
    ...
    },
    {
      ...
      tier: "ancilla",
      description:
        "You can also use this [lifepath] to represent a Warlord. You enforced the laws of vampiric society and punished those who broke them. This role came with great authority and freedom, but with heavy responsibility as well. You might have abused that authority for your own ends, but others fear the consequences of crossing you anyway.",
      skills: [
        {
          skill: "awareness",
          focus: "Insight",
  ...
  disciplines: [
    {
      ...
      description:
        "Interacting with, manipulating, and taking on aspects of animals, including shapechanging into animals and summoning animals.",
      powers: [
        {
    ...
    },
    {
      ...
      description:
        "Enhancing existing senses, tapping into a “sixth” sense, and sensing and connecting with the minds of those nearby.",
      powers: [
        {
          id: "analyze",
          name: "Analyze",
    ...
    },
    {
      ...
      description:
        "Manipulating blood to cause fantastical and magical effects.",
      powers: [],
      id: "blood_sorcery",
    },
    {
      ...
      description:
        "Moving quickly and gracefully, including dodging incoming attacks, moving nimbly across precarious surfaces, and even catching or deflecting bullets.",
      powers: [
        {
          id: "cat_s_grace",
          name: "Cat's Grace",
    ...
    },
    {
      ...
      description:
        "Tempting others away from firmly held beliefs, and poisoning their minds and bodies.",
      powers: [
        {
          id: "contradict",
          name: "Contradict",
    ...
    },
    {
      ...
      description:
        "Controlling the actions, mind, and sometimes emotions of a person or a group, turning them into puppets with limited autonomy or self-awareness.",
      powers: [
        {
          id: "apathy",
          name: "Apathy",
    ...
    },
    {
      ...
      description:
        "Fortifying both your body and mind against external forces, maintaining control of yourself physically and mentally, and sharing some of your superior vitality and sturdiness with your allies.",
      powers: [
        {
          id: "endure",
          name: "Endure",
    ...
    },
    {
      ...
      description:
        "Communing with spirits, speaking with the dead, inducing and controlling decay, and commanding the dead and undead.",
      powers: [],
      id: "necromancy",
    },
    {
      ...
      description:
        "Bewildering and mystifying the senses, typically via illusions and mind tricks only the sufferer can perceive, leaving them unable to trust their own senses and keeping you safe.",
      powers: [
        {
          id: "cloak_of_shadows",
    ...
    },
    {
      ...
      clans: "Lasombra",
      description:
        "Manipulating shadows to hide or transport you or your words, frighten or capture potential prey, and transform you into an unliving shadow.",
      powers: [
        {
    ...
    },
    {
      ...
      description:
        "Drawing on immense physical strength and martial prowess, including leaping great distances, slamming the ground hard enough to cause a localized earthquake, and ripping opponents limb from limb.",
      powers: [
        {
          id: "bull_rush",
          name: "Bull Rush",
    ...
    },
    {
      ...
      description:
        "Understanding and manipulating the emotions of those around you, stupefying onlookers, calming agitated allies, and forging or disrupting bonds between people.",
      powers: [
        {
          id: "awe",
          name: "Awe",
    ...
    },
    {
      ...
      description:
        "Using a twisted connection to the natural world to manipulate it, curse the living, twist fate, and subvert the natural order to keep you and your allies safe.",
      powers: [],
      id: "tellurgy",
    },
    {
      ...
      clans: "Tzimisce",
      description:
        "Manipulating, reshaping, and enhancing your body and the bodies of others.",
      powers: [],
      id: "vicissitude",
    },
  ],
  merits: [
    ...
    },
    {
      ...
      prerequisites: "—",
      summary:
        "Your personal code helps you keep your cool and reaffirm your beliefs.",
    ...
    },
    {
      ...
      prerequisites: "—",
      summary:
        "Your face is forgettable, giving you a bonus to Subterfuge tests.",
    ...
    },
    {
      ...
      prerequisites: "—",
      summary:
        "You know people in high society and gain a bonus when interacting with such people.",
    ...
    },
    {
      ...
      prerequisites: "—",
      summary:
        "Your sire’s reputation provides you a bonus or penalty to social tests, depending on the target's sect or clan.",
    ...
    },
    {
      ...
      prerequisites: "Duskborn or vampire.",
      summary:
        "You have some control over your hunger and gain a bonus to resist hunger frenzy.",
  ...
  natures: [
    ...
    },
    {
      ...
      name: "Bon Vivant",
      summary:
        "You know that life is shallow and fleeting. You live in the here and now and aim to have a good time no matter what.",
    ...
    },
    {
      ...
      name: "Bravo",
      summary:
        "You believe in the rule of the strong over the weak and make sure you are always the strongest around.",
    ...
    },
    {
      ...
      name: "Perfectionist",
      summary:
        "You demand flawless execution in yourself and sometimes others.",
    ...
    },
    {
      ...
      name: "Romantic",
      summary:
        "You feel existence is only fulfilling when you have others you love and who love you back.",
    ...
    },
    {
      ...
      name: "Scientist",
      summary:
        "You know existence is a puzzle and you aim to help reassemble and solve it.",
    ...
    },
    {
      ...
      name: "Survivor",
      summary:
        "You always pull through, surviving whatever the world throws at you.",
  ...
  clans: [
    {
      ...
      name: "Banu Haqim",
      description:
        "Known to be adept killers, these vampires have assumed the role of vigilantes, judges, and executioners among their brethren.",
      ...
      traits: [],
      disciplineRule: {
        fixed: ["blood_sorcery", "celerity", "obfuscate"],
      },
    },
    {
      id: "brujah",
      name: "Brujah",
      description:
        "Rebels, revolutionaries, extremists, and troublemakers. Their blood burns with the desire for change and an almost uncontrollable rage.",
      ...
      traits: [
        ...
        },
        {
          ...
          tier: "neonate",
          prerequisites:
            "Neonate or stronger. At least 1 dot in Potence and at least 1 dot in Presence.",
      ...
      disciplineRule: {
        fixed: ["celerity", "potence", "presence"],
      },
    },
    {
      id: "gangrel",
      name: "Gangrel",
      description:
        "Lone survivors who are proud to be closer to beasts than humans and other vampires. Members of this clan are some of the few undead who can call the wilds home.",
      ...
      traits: [
        {
          ...
          tier: "neonate",
          prerequisites:
            "Neonate or stronger. At least 1 dot in Animalism and 1 dot in Fortitude.",
        ...
        },
        {
          ...
          tier: "ancilla",
          prerequisites:
            "Ancilla or stronger. At least 2 dots in Celerity and 1 dot in Fortitude.",
    ...
    },
    {
      ...
      name: "Giovanni",
      description:
        "Vampires obsessed with death and the exploitation of its ramifications. Members of this clan are known to dabble in necromantic rituals and to deal with other undead creatures.",
      ...
      traits: [],
      disciplineRule: {
        fixed: ["auspex", "potence", "necromancy"],
      },
    },
    {
      id: "lasombra",
      name: "Lasombra",
      description:
        "The hidden hand in the shadows that manipulates people like pieces on a chessboard. Masters of manipulation and deception, these vampires would go to any lengths to secure what they want.",
      ...
      traits: [
        ...
        },
        {
          ...
          tier: "ancilla",
          prerequisites:
            "Ancilla or stronger. At least 2 dots in Dominate and 1 dot in either Oblivion or Corruption.",
      ...
      disciplineRule: {
        fixed: ["dominate", "potence"],
        choice: ["corruption", "oblivion"],
      },
    },
    {
      id: "malkavian",
      name: "Malkavian",
      description:
        "With their unique minds that can see beyond reality, these vampires are unified in an otherworldly network that allows them to share knowledge and visions.",
      ...
      traits: [],
      disciplineRule: {
        fixed: ["auspex", "dominate", "obfuscate"],
      },
    },
    {
      id: "ministry",
      name: "Ministry",
      description:
        "Liberators, corruptors, and preachers of self-discovery and freedom. These vampires believe that the only way to freedom is through liberating oneself from one’s own bonds.",
      ...
      traits: [
        ...
        },
        {
          ...
          tier: "ancilla",
          prerequisites:
            "Ancilla or stronger. At least 1 dot in Corruption and 1 dot in Presence.",
    ...
    },
    {
      ...
      name: "Nosferatu",
      description:
        "The clan of secrets, information, and stealth. They can’t hide their monstrous nature as other vampires can, but they are experts in hiding everything else, and in discovering what everyone else hides.",
      ...
      traits: [
        ...
        },
        {
          ...
          tier: "ancilla",
          prerequisites:
            "Ancilla or stronger. At least 2 dots in Obfuscate and 2 dots in Potence.",
      ...
      disciplineRule: {
        fixed: ["animalism", "obfuscate", "potence"],
      },
    },
    {
      id: "ravnos",
      name: "Ravnos",
      description:
        "Survivors, travelers, and deceivers. The clan seeks truth through lies and is recovering from a great loss, as many of its members were consumed by their own ancestors.",
      ...
      traits: [],
      disciplineRule: {
        fixed: ["obfuscate", "presence", "tellurgy"],
      },
    },
    {
      id: "salubri",
      name: "Salubri",
      description:
        "A clan divided into two castes: the healers who seek redemption through service, and the warriors who seek revenge on their persecutors.",
      ...
      traits: [],
      disciplineRule: {
        fixed: ["auspex", "fortitude", "obfuscate"],
      },
    },
    {
      id: "toreador",
      name: "Toreador",
      description:
        "A clan of passionate artists, tastemakers, critics, and others who embody beauty and creation. Passion and obsession for beauty run in their veins.",
      ...
      traits: [
        ...
        },
        {
          ...
          tier: "neonate",
          prerequisites:
            "Neonate or stronger. At least 1 dot in Presence and 1 dot in Auspex.",
        ...
        },
        {
          ...
          tier: "ancilla",
          prerequisites:
            "Ancilla or stronger. At least 3 dots in Presence and 1 dot in Auspex.",
      ...
      disciplineRule: {
        fixed: ["auspex", "celerity", "presence"],
      },
    },
    {
      id: "tremere",
      name: "Tremere",
      description:
        "These vampires were once mages who used magic to steal the curse of vampirism in the hopes of achieving immortality. Now their sorcery is bound by blood, and they study tirelessly to perfect their craft.",
      ...
      traits: [],
      disciplineRule: {
        fixed: ["auspex", "dominate"],
        choice: ["blood_sorcery", "necromancy"],
      },
    },
    {
      id: "tzimisce",
      name: "Tzimisce",
      description:
        "Obsessed with ownership and transformation, this clan strives to bring the world, and the very flesh of those within it, under their control and design.",
      ...
      traits: [],
      disciplineRule: {
        fixed: ["animalism", "dominate"],
        choice: ["tellurgy", "vicissitude"],
      },
    },
    {
      id: "ventrue",
      name: "Ventrue",
      description:
        "Self-proclaimed the Clan of Kings, these vampires were always involved with the ruling class throughout history, thanks to their ability to manipulate the minds and emotions of their subjects.",
      ...
      traits: [
        ...
        },
        {
          ...
          tier: "neonate",
          prerequisites:
            "Neonate or stronger. At least 1 dot in Dominate and 1 dot in Presence.",
        ...
        },
        {
          ...
          tier: "ancilla",
          prerequisites:
            "Ancilla or stronger. At least 2 dots in Fortitude and 2 dots in Presence.",
        ...
        },
        {
          ...
          tier: "ancilla",
          prerequisites:
            "Ancilla or stronger. At least 2 dots in Fortitude and 1 dot in either Dominate or Presence.",
      ...
      disciplineRule: {
        fixed: ["dominate", "fortitude", "presence"],
      },
    },
    {
      id: "caitiff",
      name: "Caitiff",
      description:
        "Also known as the Clanless, these vampires are a mixed bag who don’t bear clear signs that they are descended from any of the 14 major clans. They are often viewed as little more than stray dogs by their kin.",
  ...
  resourceTypes: [
    {
      ...
      name: "Haven",
      description:
        "A place where you can hide, relax, and enter [daysleep] without fear of the sun. Each dot increases size/security and raises the Difficulty to find or break into it.",
    },
    {
      id: "property",
      category: "Physical Asset",
      name: "Property",
      description:
        "Places you own. Each dot increases the size, number, and overall value of your holdings.",
    },
    {
      id: "repository",
      category: "Physical Asset",
      name: "Repository",
      description:
        "A collection of a valuable resource such as books, weapons, or mechanical parts. Each dot increases size and complexity.",
    },
    {
      id: "vehicle",
      category: "Physical Asset",
      name: "Vehicle",
      description:
        "A vehicle from a motorcycle to a private jet. Each dot increases size, value, and prestige.",
    },
    {
      id: "ally",
      ...
      name: "Ally",
      description:
        "Someone you can count on for help when the cost or risk is not too high.",
    },
    {
      id: "minions",
      category: "Social Asset",
      name: "Minions",
      description:
        "Each dot represents three weak individuals at your disposal.",
    },
    {
      id: "retainer",
      category: "Social Asset",
      name: "Retainer",
      description:
        "A single servant who is not a minion. Dots indicate the retainer’s NPC Level.",
    },
    {
      id: "contact",
      category: "Social Asset",
      name: "Contact",
      description:
        "A person in a field who provides information. Dots represent proficiency, knowledge, and access.",
    },
    {
      id: "fame",
      category: "Social Asset",
      name: "Fame",
      description:
        "Recognition within a culture or subculture. Dots represent reach from a small niche to an international audience.",
    },
    {
      id: "herd",
      category: "Social Asset",
      name: "Herd",
      description:
        "Mortals you can safely feed on. Each dot represents a small group available for feeding.",
    },
    {
      id: "mask",
      category: "Social Asset",
      name: "Mask",
      description:
        "Established alternate identities. Each dot represents a distinct identity and improves their quality.",
    },
    {
      id: "status",
      category: "Social Asset",
      name: "Status",
      description:
        "Political authority and respect within a specific mortal or vampiric society. One dot is a respectable member; five dots indicate a top authority figure.",
    },
    {
      id: "wealth",
      category: "Wealth",
      name: "Wealth",
      description:
        "Accessible financial worth. Each dot represents increasing ability to spend, from frugal purchases to very large donations and expenditures.",
    },
  ],
  generationByTier: {
    neonate: [13, 12, 11],
  ...
  resourceRuleText:
    "Physical and Social Assets must be specific. Each asset type has its own dots. Free Resource dots come from the Dot Distribution table in addition to Lifepath Resources.",
  focusRuleText:
    "At each odd number of dots in a Skill (1, 3, and 5), you can acquire a Focus. A relevant Focus gives +1 die to the test. During character creation, Skills cannot exceed 3 dots.",
  lifepathCompetence:
    "At the Storyteller’s discretion, when no other Skill applies but a Lifepath suggests competence, add 2 dice to the pool or gain a basic success.",
  youngCharacter:
    "Choose only one Lifepath instead of two. If used for balance, distribute an extra 3 dots among that Lifepath’s Skills and 2 dots among its Resources. A Skill still cannot exceed 3 dots during character creation.",
};
